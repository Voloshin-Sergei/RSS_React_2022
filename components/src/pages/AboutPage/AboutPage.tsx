    ...
    return (
      <div className={style.aboutPage}>
        ...
        <p className={style.aboutPage__text}>
          ...
          Roiland that premiered on December 2, 2013 on Cartoon Network&apos;s Adult Swim
          programming block. In Canada, it premiered on January 10, 2016 on the Canadian version of
          ...
          <p className={style.aboutPage__text}>
            ...
            Morty came back with a fourth season airing ten episodes with the first half of the
            season being air in 2019 and the second half after new years.
          </p>
          <p className={style.aboutPage__text}>
            The show was based on a series of crudely animated short films for Channel 101 based on
            a Back to the Future parody The Real Animated Adventures of Doc and Mharti by Justin
            Roiland.
          </p>
        </p>
      </div>
